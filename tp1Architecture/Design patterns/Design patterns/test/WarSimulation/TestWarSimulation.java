 ...
 */
public class TestWarSimulation {
    /**
     * Rigorous Test :-)
     */
    @Test
    ...
    public void showKingdom() {
        Kingdom Kingdom = new Kingdom.KingdomBuilder()
                .addKing("Youness")
    ...
    public void aKingdomHasSoldiersOnEdges() {
        Kingdom Kingdom1 = new Kingdom.KingdomBuilder()
                .addKing("Youness")
                .addCountry("France", "20", "100", "50", "200", "100", "100")
                .addCountry("Spain", "30", "200", "40", "300")
                .addSoldiersOnEdges("500")
                .build();
        Kingdom Kingdom2 = new Kingdom.KingdomBuilder()
                .addKing("Amine")
